  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-4 right-4 z-50 w-9 h-9 bg-terracotta hover:bg-terracotta-dark text-white rounded-full shadow-lg flex items-center justify-center transition-colors focus:outline-none focus:ring-4 focus:ring-terracotta-light"
