...
export function WhereToBuy() {
  return (
    <section className="mb-10">
      <h2 className="font-heading text-xl font-bold text-deep-blue mb-3">Where to Buy</h2>
      <p className="text-warm-gray-600 mb-4">
        Interested in stocking this piece? We supply museum and gallery shops across Australia.
      </p>
      <Link
        href="/wholesale"
