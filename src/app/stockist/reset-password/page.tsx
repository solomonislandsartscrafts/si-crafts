  ...
  if (!token) {
    return (
      <div className="max-w-md mx-auto px-4 sm:px-6 page-y text-center">
        ...
        <Link href="/stockist/forgot-password" className="text-ocean hover:text-ocean-dark font-medium">
    ...
    return (
      <div className="max-w-md mx-auto px-4 sm:px-6 page-y text-center">
        <div className="bg-success/10 border border-success/20 rounded-lg p-6 mb-6">
          <h1 className="font-heading text-2xl font-medium text-deep-blue mb-2">Password Reset!</h1>
  ...
  return (
    <div className="max-w-md mx-auto px-4 sm:px-6 page-y">
      ...
      <p className="text-warm-gray-600 mb-8">
        Choose a new password for your stockist account.
      </p>
