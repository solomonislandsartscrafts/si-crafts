  ...
  return (
    <div className="border border-sand rounded-lg">
      <button
        ...
        className="tap-target w-full flex items-center justify-between gap-sm px-md py-sm text-left focus:outline-none focus:ring-2 focus:ring-ocean rounded-lg"
        aria-expanded={open}
      >
