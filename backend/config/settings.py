"""
Django settings for SI Crafts Wagtail backend.
"""
import os
import re
...
# Wagtail API
WAGTAILAPI_LIMIT_MAX = 200  # Allow up to 200 items per API request
...
# and copy-pasting from Google's UI can introduce non-breaking spaces (U+00A0).
...
DEFAULT_FROM_EMAIL = os.environ.get("DEFAULT_FROM_EMAIL", "SIAC <noreply@solomonislandsartscrafts.com.au>")
